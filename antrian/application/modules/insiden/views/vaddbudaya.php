...
<div class="span10">
    <h3 class="page-title">Form Laporan Budaya Keselamatan RS Kasih Ibu</h3>

    

    <div class="well">
        <form id="user" method="post" action="<?php echo base_url(); ?>insiden/tambahbudaya ">
        ...
        <tr>
            ...
            <td>
                <select name='kejadian' id='kejadian' required>
                    ...
                    <?php
                    foreach ($cbbudaya as $cbk) {
                        if ($cbk->id_kejadian == $kejadian) { 
                            echo '<option value="' . $cbk->id_budaya . '" selected >' . $cbk->nama_kejadian . '</option>';
                        } else {

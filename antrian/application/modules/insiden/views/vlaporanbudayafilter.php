...
<div class="span10">
    <h3 class="page-title"> Filter Laporan Budaya Keselamatan</h3>

    <div class="well">
        <form id="user" method="post" action="<?php echo base_url(); ?>insiden/load_laporanbudaya ">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td valign="bottom">
                        ...
                        <input type="hidden" name='kejadian' class="form-control" value="ALL" readonly>
                    </td>
                </tr>

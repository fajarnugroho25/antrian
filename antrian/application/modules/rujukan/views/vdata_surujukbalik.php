...
<div class="span10">
            <h3 class="page-title">Data Surat Rujuk Balik</h3>
            
<div class="btn-toolbar">
	
   <a class="btn btn-primary" href="<?php echo base_url();?>rujukan/tambahsuratrujuk" role="button" >Tambah Surat</a>
		...
		<table id="example" class="table table-striped table-bordered dt-responsive " >
			...
			<tbody>
				...
				<tr>		
                    ...
                    <td><?php echo $b->diagnosa; ?></td> 
                    <td><?php echo $b->obat; ?></td> 
                    <td><?php echo $b->kepada; ?></td> 
                    					<td align="center">
                                        <a href="<?php echo base_url();?>rujukan/editrujukan/<?php echo $b->no_surat; ?>">
                                        <input type="button" value="Edit" class="tombol small gray"></a>
                                        <a href="<?php echo base_url();?>rujukan/print_rujukan/<?php echo $b->no_surat; ?>" target="_blank">

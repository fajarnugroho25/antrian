            ...
            <form id="user" method="post" action="<?php echo base_url(); ?>ruangan/verif">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <select name='ruangan' id='ruangan' required readonly>
               ...
               <tr>
                ...
                <tr>
                    <td>
                        <label><b>Verifikasi Ruangan</b></label>
                    </td>
                    <td> &nbsp &nbsp</td>
                    <td>
                    <?php if ($status == '1') {
                            $status1 = 'Ruangan Sudah Disetujui';
                    } else {
                            $status1 = 'Ruangan Belum Disetujui';
                    } ?>
                        <input type="text" id="status" name="status" value="<?php echo $status1; ?>" readonly>
                    </td>
                </tr>

                <tr>
                    <td>
                        <label><b>Verifikasi Snack</b></label>
                    </td>
                    <td> &nbsp &nbsp</td>
                    <td>
                        <input type="radio" id="status" name="status" value="1" <?php if ($status == '1') {
                                                                                    ...
                                                                                    echo '';
                                                                                } ?> required > Belum Diverifikasi &nbsp &nbsp &nbsp &nbsp
                        <input type="radio" id="status" name="status" value="2" <?php if ($status == '2') {
                                                                                    echo 'checked';
                                                                                } else {
                                                                                    echo '';
                                                                                } ?> required > Verifikasi &nbsp &nbsp &nbsp &nbsp
                    </td>
                </tr>

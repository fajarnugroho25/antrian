  ...
  <body> 
    <div class="navbar">
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <a class="brand" href="#"><span class="first">Form Login  </span> <span class="second"> </span></a>
            </div>
        </div>
    </div>
    ...
    <div class="dialog span4">
        ...
        <?php echo "<center style='color:red'>".$error."</center>"; ?>  
                <form method="post" action="<?php echo base_url();?>index.php/login/masuk" id="loginform">

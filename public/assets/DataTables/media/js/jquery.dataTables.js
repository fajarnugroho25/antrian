		...
		(/** @lends <global> */function ($) {
		  ...
		  *//**
			...
			*/
			...
			//untuk sorting dan pengatudan kolom datatable inget yaaa
			...
			$(document).ready(function () {
				var t = $('#insiden').DataTable({
					...
					buttons: [
						{
							extend: 'excelHtml5',
							messageTop: 'Data Laporan Insiden KPRS Kasih Ibu Surakarta'
						},
						// 'copyHtml5',
			...
			$(document).ready(function () {
				var t = $('#insiden3').DataTable({
					...
					buttons: [
						{
							extend: 'excelHtml5',
							messageTop: 'Data Laporan Insiden K3 RS Kasih Ibu Surakarta'
						},
						// 'copyHtml5',

...
<div class="span10">
    <h3 class="page-title">Data Laporan Pajanan RS Kasih Ibu</h3>

    <div class="btn-toolbar">
        <a class="btn btn-primary" href="<?php echo base_url(); ?>insiden/formpajananA" role="button">Input Laporan Pajanan Form A</a>
    </div>
    ...
    <div class="well">
        ...
        <table id="insiden2" class="table table-striped table-bordered ">
            ...
            <tbody>
                ...
                <?php foreach ($datapajananA as $l) { ?>
                    <tr>
                        <td></td>
                        <td><?php echo $l->id_laporan; ?></td>
                        <td><?php echo date_format(date_create($l->tgl_pajanan), 'd-m-Y'); ?></td>
                        <td><?php echo $l->tempat_kejadian; ?></td>
                        <td><?php echo $l->nama; ?></td>
                        <td><?php echo date_format(date_create($l->tgl_laporan), 'd-m-Y'); ?></td>
                        ...
                        <td align="center">
                            ...
                            <?php if ($l->stat == 0) { ?>
                                <?php if ($this->session->kprs == 1) { ?>
                                    ...
                                    <a href="<?php echo base_url(); ?>insiden/verifpajananA/<?php echo $l->id_laporan; ?>"onclick="return confirm('Anda yakin Ingin Verif Data ?')">
                                ...
                                <?php } else if ($this->session->kprs == 2) { ?>
                                        ...
                                        <a href="<?php echo base_url(); ?>insiden/cetakpajananA/<?php echo $l->id_laporan; ?> ">

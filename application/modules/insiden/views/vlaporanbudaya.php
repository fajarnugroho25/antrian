...
<div class="span10">
    <h3 class="page-title">Data Laporan Budaya Keselamatan</h3>
            ...
            <thead>
                ...
                <tr>
                   ...
                   <!--  <th>Tanggal Insiden</th> -->
                    <th>Unit Kerja</th>
                    <th>Perilaku Yang Tidak Layak</th>
                    <th>Perilaku Yang Distruptive</th>
                    <th>Perilaku Yang Melecehkan</th>
                    <th>Pelecehan Seksual</th>
                </tr>
            </thead>
            <tbody>

                <?php foreach ($laporanbudaya as $l){ ?> 
                    <tr >            
                        <td></td>
                        <!-- td><?php echo $l->tgl_insiden; ?></td> -->
                        <td><?php echo $l->unit_nama; ?></td>
                        <td><?php echo $l->ptk; ?></td>
                        <td><?php echo $l->pd; ?></td>
                        <td><?php echo $l->pm; ?></td>
                        <td><?php echo $l->ps; ?></td>

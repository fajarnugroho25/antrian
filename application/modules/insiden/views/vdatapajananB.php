...
<div class="span10">
    ...
    <div class="btn-toolbar">
        <a class="btn btn-primary" href="<?php echo base_url(); ?>insiden/formpajananB" role="button">Input Laporan Pajanan Form B</a>
    </div>
    ...
    <div class="well">
        ...
        <table id="insiden2" class="table table-striped table-bordered ">
            ...
            <tbody>
                ...
                <?php foreach ($datapajananB as $l) { ?>
                    <tr>
                        <td></td>
                        <td><?php echo $l->id_laporan; ?></td>
                        <td><?php echo date_format(date_create($l->tgl_pemberitahuan), 'd-m-Y'); ?></td>
                        ...
                        <td align="center">
                            ...
                            <?php if ($l->stat == 0) { ?>
                                <?php if ($this->session->kprs == 1) { ?>
                                    ...
                                    <a href="<?php echo base_url(); ?>insiden/verifpajananB/<?php echo $l->id_laporan; ?>"onclick="return confirm('Anda yakin Ingin Verif Data ?')">
                                        <input type="button" value="Verifikasi" class="btn btn-info"></a>
                                    <!-- <a href="<?php echo base_url(); ?>insiden/cetakpajananB/<?php echo $l->id_laporan; ?> ">

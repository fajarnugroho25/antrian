...
$verifikator = $this->session->nama;
    ...
    foreach ($datainsiden as $row) :     
      ...
      $jenis_pelindung = $row->jenis_pelindung;
...
<div class="span10">
    ...
    <div class="well">
        <form id="user" method="post" action="<?php echo base_url(); ?>insiden/inputverifpajananA">
            ...
            <tr>
                <td valign="top">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td>
                            ...
                            value="Tidak" id="tidakdipakai" reqiured>  Tidak
                        </td>
                    </tr>

                    <tr id="jenis_pelindung">
                        <input type="hidden" id="jenisp" name="jenisp" value="<?php echo $jenis_pelindung ?>">
                            <td valign="center">
                                <label><b>Jenis Pelindung</b></label>
                            </td>
                            <td> </td>
                            <td>
                                <input type="text" name="jenis_pelindung" value="<?= $jenis_pelindung; ?>"></input>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <tr id="jenis">
                            <td valign="top">
                                <input type="hidden" id="jenis2" name="jenis2" value="<?php echo $jenis_pertolongan ?>">

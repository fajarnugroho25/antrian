...
<div class="span10">
    ...
    <div class="well">
        <form id="user" method="post" action="<?php echo base_url(); ?>insiden/tambahpajananA">
        ...
        <tr>
            ...
            <td> </td>
            <td>
                    <input type="text" id="tgl_laporan" name="tgl_laporan" value="<?= $tgl_laporan; ?>" readonly ></input>
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <div id="datetimepicker" class="input-append date">
                    <input type="text" id="tgl_pajanan" name="tgl_pajanan" value="<?= $tgl_pajanan; ?>" required></input>
                    <span class="add-on">

...
<div class="span10">
    <h3 class="page-title">Data Laporan Insiden K3 RS Kasih Ibu</h3>

    <div class="btn-toolbar">
        <a class="btn btn-primary" href="<?php echo base_url(); ?>insiden/forminsidenk3" role="button">Input Laporan Insiden</a>
    </div>
                        ...
                        <td align="center">
                            ...
                            <?php if ($l->stat==0) { ?>
                                <?php if ($this->session->kprs==1) { ?>
                                    <a href="<?php echo base_url(); ?>insiden/verifkejadian/<?php echo $l->id_laporan; ?>">
                                        <input type="button" value="Verifikasi" class="btn btn-info"></a>

                                        <a href="<?php echo base_url(); ?>insiden/cetakk3/<?php echo $l->id_laporan; ?> " target="_blank">

...
<div class="span10">
       <h3 class="page-title"><?php echo $titel; ?> Data Pengajuan Cuti</h3>               
<div class="well">
...
<table border="0">
    <td>
        <table>
            ...
            <td></td>
            <td>
             <input type="text" name='id_cuti' class="form-control" value="<?= $kodejadi; ?>" readonly>
            </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td> </td>
                <td>
                    <input type="text" name='bagian' id="bagian" class="form-control" value="<?= $data->unit_nama; ?>" readonly>
                </td>   
            </tr> 
            ...
            <tr>
                ...
                <td> </td>
                <td>
                    <input type="text" name='mhari' id="mhari" class="form-control" value="" required> Hari Kerja 
                </td>   
                <td>
                    <div id="datetimepicker" class="input-append date">
                            <input type="text" id="mtglawal" name="mtglawal" class="form-control "  required></input>
                            <span class="add-on">
                ...
                <td><div id="datetimepicker1" class="input-append date">
                            <input type="text" id="mtglakhir" name="mtglakhir" class="form-control "  required></input>
                            <span class="add-on">
                                <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
                            </span>
                        </div></td>    
            ...
            <tr>
                ...
                <td> </td>
                <td>
                    <input type="text" name='sisacutitahun' id="sisacutitahun" class="form-control" value="<?=$sisacutitahun?>" readonly>
                </td>   
            </tr> 
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <label><b>Sisa Cuti Tahunan Anda</b></label>
                </td>
                <td> </td>
                <td>
                    <input type="text" name='sisacutipribadi' id="sisacutipribadi" value="<?=$sisacuti?>" class="form-control" readonly>
                </td>   
            </tr>
             <!--  <tr>
                <td>
                    <label><b>Status CB</b></label>
                </td>
                <td> </td>
                <td>
                    <input type="text" name='sudahambilcb' id="sudahambilcb" value="<?=$sudahambilcb?>" class="form-control" readonly>
                </td>   
            </tr> -->
            <tr>
                <td>
                    <label><b>Sisa Cuti Besar Anda</b></label>
                </td>
                <td> </td>
                <td>
                    <input type="text" name='sisacutibesar' id="sisacutibesar" class="form-control" value="<?=$sisacutiBesar?>" readonly><p style="color: red">Exp  <?=$tahunexp?></p>
                </td>   
            </tr>  
...
<script type="text/javascript">
 ...
 // $(‘#submitPermintaan’).click(function(){
...

       {
         ...
         // sudahambilcb: $('select[name=sudahambilcb]').val(),
       }

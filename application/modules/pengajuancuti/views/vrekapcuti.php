    ...
    <table >
           ...
           <tr>
            ...
            <tr>
              ...
              <button class="btn btn-primary" id="printall">Print Semua Unit</button>
              </td>
          </tr>
...
$(document).ready( function () {
    $('#pengajuan').DataTable({
        "ajax": {
                "url": base_url+"index.php/pengajuancuti/ajaxrekapcuti",
                "type": "POST"
              },
         ...
         tahun: $('select[name=tahun]').val()
            ...
            $.ajax({
                ...
                success:function(Data){
                    ...
                    window.open(base_url + "pengajuancuti/printrekapcuti/");
                },
            function(isConfirm){
  ...
  $(document).on("click", "#printall", function(){
       ...
       window.open(base_url + "pengajuancuti/printAllrekapcuti/");
        
        });


  $(document).on("click", "#cutibesar", function(){

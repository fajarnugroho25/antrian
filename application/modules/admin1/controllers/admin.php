...
class admin extends CI_Controller {
 ...
 public function tambahadmin()
      ...
      public function editadmin()
  {
   ...
   public function editakses()
	...
	public function tambah()
	{
            ...
            $unit_id = $this->input->post('unitkary');
            ...
            if ($this->input->post('user')==''){
                ...
                echo "<script>alert('Ups, Password Masih Kosong !'); history.go(-1);</script>";   
                    ...
                    // Simpan Data
                   $result = $this->madmin->simpan($user,$nama, $pass,$unit_id,$addgudang,$nik, $admin_status, $status);
                   if ($result){
        ...
        public function perbarui()
  {
            ...
            $admin_status = $this->input->post('admin_status');
            $status = $this->input->post('status');
            $unitkary = $this->input->post('unitkary');
            $gudang_id = $this->input->post('gudang_id');
            $addgudang = implode(",", $gudang_id);
            ...
            if ($this->input->post('user')==''){
                echo "<script>alert('Ups, Username Masih Kosong !'); history.go(-1);</script>";   
                    ...
                    // Simpan Data
                   $result = $this->madmin->perbarui($id, $user,$nama, $pass,$addgudang , $admin_status, $status,$unitkary);
                   if ($result){

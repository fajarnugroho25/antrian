...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Form Login My RSKI | RS Kasih Ibu Surakarta</title>
  ...
  <body> 
    <div class="navbar">
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <a class="brand" href="#"><span class="first">Form Login My RSKI | </span> <span class="second"> RS Kasih Ibu Surakarta</span></a>
            </div>
        </div>
    </div>
    ...
    <div class="dialog span4">
        ...
        <center><h2><?php echo "IP: "; echo $_SERVER['REMOTE_ADDR']; ?></h2></center>
                <form method="post" action="<?php echo base_url();?>login/masuk" id="loginform">

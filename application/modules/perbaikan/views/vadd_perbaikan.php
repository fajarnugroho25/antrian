...
<div class="span10">
    <h3 class="page-title">
        <?php echo $titel; ?> Permintaan Perbaikan</h3>
        ...
        <form id="user" method="post" action="<?php echo base_url(); ?>perbaikan/<?php echo $aksi; ?>">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                        <input type="text" id="user_peminta" name="user_peminta" value="<?php echo $user_peminta; ?>" required>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td></td>
                    <td>
                         <textarea style="" id="keluhan" name="keluhan" rows="4"  required><?php echo $keluhan; ?></textarea>
                        <!-- <input type="text" id="keluhan" name="keluhan" value="<?php echo $keluhan; ?>" required> -->
                    </td>
                </tr>
                <tr>
                    <td>

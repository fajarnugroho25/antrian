...
<div class="span10">
    <h3 class="page-title">
         Penugasan Perbaikan Umum / IPSRS</h3>
        ...
        <form id="user" method="post" action="<?php echo base_url(); ?>perbaikan/<?php echo $aksi; ?>">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                         <textarea style="" id="keluhan" name="keluhan" rows="4"  required placeholder="Tulis Keluhan, Lokasi Titik Perbaikan dan Keterangan Lengkap" readonly><?php echo $keluhan; ?></textarea>
                ...
                <tr>
                    <td>
                        <label><b>Petugas Perbaikan</b></label>
                    </td>
                    <td></td>
                    <td>
                ...
                <tr>
                                ...
                                <td> &nbsp &nbsp</td>
                                <td>
                                    <input type="radio" id="status" name="status" value="1" <?php if ($status == '0') {
                                                                                                echo 'checked';
                                                                                            } else {
                                                                                                echo '';
                                                                                            } ?> required > Belum direspon &nbsp &nbsp &nbsp &nbsp
                                    <input type="radio" id="status" name="status" value="2" <?php if ($status == '1') {
                                                                                                echo 'checked';
                                                                                            } else {
                                                                                                echo '';
                                                                                            } ?> required > Direspon &nbsp &nbsp &nbsp &nbsp
                                    <input type="radio" id="status" name="status" value="0" <?php if ($status == '2') {
                                                                                                echo 'checked';
                                                                                            } else {
                                                                                                echo '';
                                                                                            } ?> required > Diproses &nbsp &nbsp &nbsp &nbsp

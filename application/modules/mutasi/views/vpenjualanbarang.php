...
<div class="span10">
       <h3 class="page-title"><?php echo $titel; ?> Penjualan Barang Inventaris</h3>               
<div class="well">
...
<table border="0">
  ...
  <table >
    <input type="hidden" id="kodeinventaris" name='kodeinventaris' class="form-control"  readonly></td>
            ...
            <td></td>
            <td>
             <input type="text" name='kodejual' class="form-control" value="<?= $kodejadi; ?>" readonly>
            </td>
            </tr>
            <tr>
                <td>
...
$(document).ready( function () {
   dataTableHasil= $('#hasil').DataTable({
        "ajax": {
                "url": base_url+"index.php/mutasi/ajaxListBarangjual",
                "type": "POST"
              },
              "emptyTable": "Tidak Ada Data Pesan",
              "info": "Menampilkan _START_ sampai _END_ dari _TOTAL_ entries",
...
<script type="text/javascript">
    ...
    $(document).on("click", "#tambahdata", function(){
       ...
       // console.log(data);
        url = "<?php echo base_url();?>mutasi/addbarangjual";
            // do_upload
            $.ajax({
                url:url,
                data:data,
 ...
 $(document).on("click", "#submitPermintaan", function(){
        ...
        var data ={
        kodebarang :$('input[name=kodejual]').val(),
        ket : $('select[name=ket]').val(),
       ...
       // console.log(data);
        ...
        url = "<?php echo base_url();?>mutasi/Addjualbarang";
            // do_upload
            $.ajax({
                url:url,
                data:data,
                ...
                success:function(Data){
                    ...
                    document.location = "<?php echo base_url();?>mutasi/jualbarang";
                },
            function(isConfirm){
  ...
  function deleteH(id,noinven){
    url = base_url+"index.php/mutasi/deletejual";

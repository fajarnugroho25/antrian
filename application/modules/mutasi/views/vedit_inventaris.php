        ...
        <table>
            ...
            <tr>
             ...
             <tr>
                ...
                <td> </td>
                <td>
                    <input type="text" id="merk" value="<?=$asset->assetmerk?>" class="form-control asset" name="merk" > 
                </td>    
            </tr> 
             ...
             <tr>
                ...
                <td> </td>
                <td>
                    <input type="text" id="type" value="<?=$asset->assettype?>" class="form-control asset" name="type" > 
                </td>    
            </tr> 
            ...
            <tr>
                ...
                <td> </td>
                <td>
                    <input type="text" id="noseri" value="<?=$asset->assetnoseri?>" class="form-control asset" name="noseri" > 
                </td>    
            </tr> 
            ...
            <tr>
                ...
                <td> </td>
                <td>
                    <input type="text" id="belidr" class="form-control asset" value="<?=$asset->assetbelinama?>" name="belidr" value=""  > 
            ...
            <tr>
                ...
                <td> </td>
                <td>
                   Rp. <input type="text" id="hargabel" value="<?=number_format($asset->assetbelijumlah,0,',','.')?>" class="form-control asset" name="hargabel" style="width:275px;" > 
                </td>    
            </tr>
            <tr>
                <td>

...
<div class="span10">
            <h3 class="page-title">Data Pengajuan Surat Internal</h3>  <!--<?php echo $this->session->user_name; ?> -->
            
<div class="btn-toolbar">
    <a class="btn btn-primary" href="<?php echo base_url();?>sekretariat/suratinternal" role="button">Tambah Pengajuan</a>
</div>
...
<div class="well">
		...
		<table id="sekretariat" class="table table-striped table-bordered data">
			...
			<tbody>
        <?php foreach ($pengajuaninternal as $p){ ?> 
				<tr>			
                   	...
                   	<td align="center">
                   			<?php
                   				if($p->status=='Sudah Disetujui'){ ?>
                   					Sudah Disetujui
                   				<?php } else { ?>
                   					<a href="<?php echo base_url();?>sekretariat/editinternal/<?php echo $p->id_surat; ?>">

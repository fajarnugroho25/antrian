...
<div class="span10">
    <h3 class="page-title">
        <?php echo $titel; ?> Peminjaman Ruangan</h3>

        <div class="well">
            <form id="user" method="post" action="<?php echo base_url(); ?>ruangan/<?php echo $aksi ?>">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <select name='ruangan' id='dropdown' required>
                                <option value='' disabled selected>Pilih Ruangan</option>

                                <?php
                                foreach ($cbruang as $cbruang) {
                                    if ($cbruang->id_ruang == $ruangan1) {
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <input type="text" id="textInput" name="lainnya" value="<?php echo $lainnya; ?>" required>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div id="datepicker" class="input-append date">
                                <input type="text" id="tanggal" name="tanggal" value="<?php echo $tanggal ?>" required></input>
                                <span class="add-on">
                    ...
                    <tr>
                        ...
                        <td>
                            <div id="timepicker" class="input-append time">
                                <input type="text" id="timepicker" name="waktu" value="<?php echo $waktu ?>" required></input>
                                <span class="add-on">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <input type="text" id="durasi" name="durasi" value="<?php echo $durasi; ?>" required>
                        </td>
                    </tr>
